# -*- coding: utf-8 -*-
"""germantrafficlightdetecting_model.ipynb
...
# Assuming DatasetConfig is defined as in your provided code
dataset_config = DatasetConfig()

train_dataset = image_dataset_from_directory(
    dataset_config.DATA_ROOT_TRAIN,
    labels='inferred',
    label_mode='int',
...
# Create the test dataset using image_paths and label_ids
...
valid_dataset = image_dataset_from_directory( # Changed line: Completed the function name
    dataset_config.DATA_ROOT_VALID,          # Changed line: Using the path for validation data
    labels='inferred',
    label_mode='int',
    image_size=(dataset_config.IMG_HEIGHT, dataset_config.IMG_WIDTH),
    interpolation='nearest',
    batch_size=TrainingConfig.BATCH_SIZE,
    shuffle=False                             # Changed line: Typically don't shuffle validation data
)
